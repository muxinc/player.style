  ...
  return (
    <>
      <Grid className="flex-1">
        ...
        <p className="text-md mb-0.5 md:mr-8">The Player.style team built Video.js and contributed to most of your favorite streaming site players, so this ain&rsquo;t our first rotoscope. And we all work at <a href="https://mux.link/player-style">Mux</a>, in case you&rsquo;re looking for some video hosting to pair with your player. We hope player.style helps you find the ideal player for whatever you&rsquo;re trying to do with video.</p>
