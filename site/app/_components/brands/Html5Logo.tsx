...
/** Brand mark from the Video.js 10 site's `assets/logos/brands/html5.svg`. */
export default function Html5Logo(props: SVGProps<SVGSVGElement>) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 361" aria-hidden="true" {...props}>
