...
/** Brand mark from the Video.js 10 site's `assets/logos/brands/vue.svg`. */
export default function VueLogo(props: SVGProps<SVGSVGElement>) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 221" aria-hidden="true" {...props}>
