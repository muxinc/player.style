...
/*
 * Essentials for Video.js 10, React component.
 *
    ...
    >
      ...
      <Controls.Root>
        <Controls.Content className="ps-chrome">
          ...
          {/* One rounded bar, inset from the bottom edge. */}
          <div className="ps-bar">
            ...
            <SeekButton className="ps-button ps-seek-backward" seconds={-10}>
              <svg className="ps-icon" aria-hidden="true" viewBox="0 0 22 24">
                <svg className="ps-icon path0" aria-hidden="true" viewBox="0 0 22 24">
            ...
            {/* The elapsed time alone, as the original's bare media-time-display showed it. */}
