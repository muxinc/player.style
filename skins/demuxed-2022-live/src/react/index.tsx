 ...
 * a Live button in the time display's place. The stylesheet is the on-demand skin's, shipped again as
 * `@player.style/demuxed-2022-live/skin.css`; it is not imported here so the component stays CSS-agnostic.
 */
import {
  AirPlayButton,
  CaptionsButton,
...
export type Demuxed2022LiveSkinProps = ContainerProps;
 ...
 *   ```;
 */
export function Demuxed2022LiveSkin({ children, className, ...rest }: Demuxed2022LiveSkinProps) {
  return (
    <Container
    ...
    >
      ...
      <Controls.Root>
        <Controls.Content className="ps-layer">
          ...
          {/* A translucent pill inset 30px from the edges; flat and full-width below 600px. No time controls. */}
          <div className="ps-bar">
            ...
            {/* The Live button takes the time display's place; the time slider's share of the pill stays empty. */}
            <LiveButton className="ps-live-button">
              <svg className="ps-icon ps-live-indicator" aria-hidden="true" viewBox="0 0 16 16">
