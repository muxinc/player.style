...
/*
 * Video.js 4 for live video on Video.js 10, React component.
 *
 ...
 * `@player.style/videojs-4-live/skin.css`.
 */
import {
  BufferingIndicator,
  CaptionsButton,
...
export type Videojs4LiveSkinProps = ContainerProps;
...
/**
 * The 2013 Video.js 4 default skin for live video around a `Video`, inside a Video.js `LiveVideoPlayer`: the
 * LIVE label in place of the progress strip and the time readout.
 *
 * @example
 *   ```tsx
 ...
 *   ```;
 */
export function Videojs4LiveSkin({ children, className, ...rest }: Videojs4LiveSkinProps) {
  return (
    <Container
      ...
      <Controls.Root>
        <Controls.Content className="ps-layer">
          <div className="ps-bar">
            ...
            {/* 4.x's live display: the word LIVE in a 40px cell where the time readout sat, in the bar's type. */}
            <LiveButton className="ps-live-button">
              <span className="ps-live-indicator" />
