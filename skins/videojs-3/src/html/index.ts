/*
 * Video.js 3 for Video.js 10, HTML element: registers `<videojs-3-skin>`.
 *
...
const TAG_NAME = 'videojs-3-skin';

/* The host is a plain box; everything visual lives on `.ps-videojs-3` inside. */
...
/**
 * `<videojs-3-skin>`: the 2011 Video.js 3 default skin around a `<video>`, inside a Video.js `<video-player>`.
 *
 * @example
 *   ```html
 *   <video-player>
 ...
 *   ```;
 */
export class Videojs3SkinElement extends BaseElement {
...
if (isBrowser && !customElements.get(TAG_NAME)) {
  customElements.define(TAG_NAME, Videojs3SkinElement);
}

declare global {
  interface HTMLElementTagNameMap {
    [TAG_NAME]: Videojs3SkinElement;
  }
}
