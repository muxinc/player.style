...
const TAG_NAME = 'demuxed-2022-skin';
...
/**
 * `<demuxed-2022-skin>`: the Demuxed 2022 theme around a `<video>`, inside a Video.js `<video-player>`.
 *
 * @example
 *   ```html
 *   <video-player>
 ...
 *   ```;
 */
export class Demuxed2022SkinElement extends BaseElement {
...
if (isBrowser && !customElements.get(TAG_NAME)) {
  customElements.define(TAG_NAME, Demuxed2022SkinElement);
}

declare global {
  interface HTMLElementTagNameMap {
    [TAG_NAME]: Demuxed2022SkinElement;
  }
}
