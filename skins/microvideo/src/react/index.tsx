...
/*
 * Microvideo for Video.js 10, React component.
 *
...
export interface MicrovideoSkinProps extends ContainerProps {
   ...
   * `top`, `center`, `bottom`. Unset means `end center`. Rendered as `data-controlbar-place` on the container.
   */
  controlBarPlace?: string | undefined;
  /**
   * Stack the controls in a 40px column, with the volume slider opening vertically (the theme's `controlbarvertical`).
   * Rendered as `data-controlbar-vertical` on the container.
   */
  controlBarVertical?: boolean | undefined;
}
          ...
          <div className="ps-bar">
            <div className="ps-group">
              ...
              <span className="ps-volume">
                ...
                <span className="ps-volume-span">
                  <VolumeSlider.Root
                    className="ps-volume-slider"
                    orientation={controlBarVertical ? 'vertical' : 'horizontal'}
                  >
