...
export type MicrovideoSkinProps = ContainerProps;
...
/**
 * The Microvideo theme around a `Video`, inside a Video.js `VideoPlayer`.
 *
 * @example
 *   ```tsx
 ...
 *   ```;
 */
export function MicrovideoSkin({ children, className, ...rest }: MicrovideoSkinProps) {
  return (
    <Container
