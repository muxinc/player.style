/*
 * The shadow-DOM host both HTML editions of Microvideo share. Each edition subclasses it with its own template
 * (`<microvideo-skin>` for on-demand video, `<microvideo-live-skin>` for the live-video preset); the base owns the
 * shadow root, the shared stylesheet, and the host variants the Media Chrome theme exposed as attributes.
 */
...
/** One shared stylesheet for every instance of either edition, parsed once. */
