 ...
 * component stays CSS-agnostic; consumers import `@player.style/x-mas/skin.css`.
 */
import {
  AirPlayButton,
  CastButton,
...
/**
 * The X-mas theme around a `Video`, inside a Video.js `VideoPlayer`.
 *
 * @example
 *   ```tsx
 ...
 *   ```;
 */
export function XMasSkin({ children, className, ...rest }: ContainerProps) {
  return (
    <Container
      ...
      <Controls.Root>
        <Controls.Content className="ps-layer">
          ...
          <div className="ps-bar">
            {/* A candy-cane fill with a Christmas tree for a thumb. */}
