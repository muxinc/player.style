/*
 * Video.js 4 for Video.js 10, HTML element: registers `<videojs-4-skin>`.
 *
...
/**
 * `<videojs-4-skin>`: the 2013 Video.js 4 default skin around a `<video>`, inside a Video.js `<video-player>`.
 *
 * @example
 *   ```html
 *   <video-player>
 ...
 *   ```;
 */
export class Videojs4SkinElement extends BaseElement {
...
if (isBrowser && !customElements.get(TAG_NAME)) {
  customElements.define(TAG_NAME, Videojs4SkinElement);
}

declare global {
  interface HTMLElementTagNameMap {
    [TAG_NAME]: Videojs4SkinElement;
  }
}
