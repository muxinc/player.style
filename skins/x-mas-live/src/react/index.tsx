 ...
 * the seek hotkeys the original's live rule dropped, with a Live button where the time range started. The stylesheet
 * is the on-demand skin's, shipped again as `@player.style/x-mas-live/skin.css`; it is not imported here so the
 * component stays CSS-agnostic.
 */
import {
  AirPlayButton,
  CastButton,
...
export type XMasLiveSkinProps = ContainerProps;
...
function VolumeIcons() {
  ...
  return (
    <>
      <svg className="ps-icon ps-icon-volume-off" viewBox="0 0 23 18" fill="none" aria-hidden="true">
        <path
      ...
      <svg className="ps-icon ps-icon-volume-low" viewBox="0 0 23 18" fill="none" aria-hidden="true">
        <path
          fillRule="evenodd"
          clipRule="evenodd"
      ...
      <svg
        className="ps-icon ps-icon-volume-medium"
        viewBox="0 0 23 18"
      ...
      <svg className="ps-icon ps-icon-volume-high" viewBox="0 0 23 18" fill="none" aria-hidden="true">
        <path
          fillRule="evenodd"
          clipRule="evenodd"
          d="M17.6117 5.41744C17.9334 5.203 18.368 5.28992 18.5824 5.61159C19.1762 6.50218 19.45 7.64604 19.45 8.74988C19.45 9.85372 19.1762 10.9976 18.5824 11.8882C18.368 12.2098 17.9334 12.2968 17.6117 12.0823C17.29 11.8679 17.2031 11.4333 17.4176 11.1116C17.8238 10.5022 18.05 9.64604 18.05 8.74988C18.05 7.85372 17.8238 6.99758 17.4176 6.38817C17.2031 6.0665 17.29 5.63189 17.6117 5.41744Z"
 ...
 *   ```;
 */
export function XMasLiveSkin({ children, className, ...rest }: XMasLiveSkinProps) {
  return (
    <Container
      className={classNames('media-skin ps-x-mas', className)}
      data-theme="x-mas"
    ...
    >
      ...
      {/* No tap gesture: the original's full-size centred chrome swallowed clicks on the picture. */}
      ...
      <Controls.Root>
        <Controls.Content className="ps-layer">
          {/* Garlands of fairy lights along the top edge, over a dark fade. */}
          <div className="ps-top">
            <svg
              className="ps-garland ps-garland-right"
              preserveAspectRatio="xMidYMid meet"
              viewBox="0 0 310 169"
              aria-hidden="true"
            >
            ...
            <svg
              className="ps-garland ps-garland-left"
              preserveAspectRatio="xMidYMid meet"
              viewBox="0 0 289 148"
              fill="none"
              aria-hidden="true"
          ...
          {/* The play button is a bauble hanging from the top edge: green with a play glyph, red with a pause glyph. */}
          <div className="ps-center">
            <PlayButton className="ps-play-button">
              <svg className="ps-icon ps-icon-play" viewBox="0 0 90 259" fill="none" aria-hidden="true">
                <g>
                  <g>
                    <g>
                      <path
              ...
              <svg className="ps-icon ps-icon-pause" viewBox="0 0 90 259" fill="none" aria-hidden="true">
                <g>
                  <g>
                    <g>
                      <path
                      ...
                      <g>
                        ...
                        <g>
                          <rect x="35" y="189.256" width="6.66667" height="24.4444" rx="3.33333" fill="#FFE4C7">
                            <animate
                              attributeName="x"
                              values="35;37.342;35"
                              begin="0s"
                          ...
                          <rect x="48" y="189" width="6.66667" height="24.4444" rx="3.33333" fill="#FFE4C7">
                            <animate
                              attributeName="x"
          ...
          <div className="ps-bar">
            {/* A bauble and "Live" where the time range started; the bauble turns red at the live edge. */}
            <LiveButton className="ps-live-button">
              <svg className="ps-icon ps-live-indicator" viewBox="0 0 12 16" aria-hidden="true">
                <path d="M6 4.5a5.5 5.5 0 1 1 0 11a5.5 5.5 0 1 1 0-11Z" />
                <path d="M4 1.5h4v3.25H4Z" fill="#F8B000" />
                <path d="M4.25 7.25a1 1 0 1 1 0 2a1 1 0 1 1 0-2Z" fill="#fff" fillOpacity=".6" />
              </svg>
              <span className="ps-live-text">Live</span>
            </LiveButton>

            {/* The volume slider pops up above the mute button while either is hovered or focused. */}
            ...
            <CastButton className="ps-button ps-cast-button">
              <svg className="ps-icon ps-icon-cast" viewBox="0 0 21 20" fill="none" aria-hidden="true">
                <path
                  fillRule="evenodd"
                  clipRule="evenodd"
            ...
            <AirPlayButton className="ps-button ps-airplay-button">
              <svg className="ps-icon ps-icon-airplay" viewBox="0 0 22 20" fill="none" aria-hidden="true">
                <path
                  fillRule="evenodd"
                  clipRule="evenodd"
            ...
            <FullscreenButton className="ps-button ps-fullscreen-button">
              <svg
                className="ps-icon ps-icon-fullscreen-enter"
                preserveAspectRatio="xMidYMid meet"
                viewBox="0 0 24 18"
                fill="none"
                aria-hidden="true"
              ...
              <svg
                className="ps-icon ps-icon-fullscreen-exit"
                preserveAspectRatio="xMidYMid meet"
                viewBox="0 0 23 18"
                fill="none"
                aria-hidden="true"
